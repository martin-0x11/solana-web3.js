 ...
 */
declare type PublicKeyInitData = number | string | Buffer | Uint8Array | Array<number> | PublicKeyData;
/**
 ...
 */
declare type StakeInstructionType = 'AuthorizeWithSeed' | 'Authorize' | 'Deactivate' | 'Delegate' | 'Initialize' | 'Split' | 'Withdraw' | 'Merge';
/**
...
export { Account, AccountBalancePair, AccountChangeCallback, AccountInfo, AccountMeta, AdvanceNonceParams, AllocateParams, AllocateWithSeedParams, AssignParams, AssignWithSeedParams, AuthorizeNonceParams, AuthorizeStakeParams, AuthorizeWithSeedStakeParams, Authorized, BPF_LOADER_DEPRECATED_PROGRAM_ID, BPF_LOADER_PROGRAM_ID, BlockResponse, Blockhash, BpfLoader, Cluster, Commitment, CompiledInnerInstruction, CompiledInstruction, ConfirmOptions, ConfirmedBlock, ConfirmedBlockSignatures, ConfirmedSignatureInfo, ConfirmedSignaturesForAddress2Options, ConfirmedTransaction, ConfirmedTransactionMeta, Connection, ConnectionConfig, ContactInfo, Context, CreateAccountParams, CreateAccountWithSeedParams, CreateEd25519InstructionWithPrivateKeyParams, CreateEd25519InstructionWithPublicKeyParams, CreateNonceAccountParams, CreateNonceAccountWithSeedParams, CreateSecp256k1InstructionWithEthAddressParams, CreateSecp256k1InstructionWithPrivateKeyParams, CreateSecp256k1InstructionWithPublicKeyParams, CreateStakeAccountParams, CreateStakeAccountWithSeedParams, DataSizeFilter, DataSlice, DeactivateStakeParams, DelegateStakeParams, Ed25519Keypair, Ed25519Program, Enum, EpochCredits, EpochInfo, EpochSchedule, FeeCalculator, FetchMiddleware, Finality, GetLargestAccountsConfig, GetParsedProgramAccountsConfig, GetProgramAccountsConfig, GetProgramAccountsFilter, HttpHeaders, InflationGovernor, InflationReward, Info, InitializeNonceParams, InitializeStakeParams, KeyedAccountInfo, Keypair, LAMPORTS_PER_SOL, LargestAccountsFilter, LeaderSchedule, Loader, Lockout, Lockup, Logs, LogsCallback, LogsFilter, MAX_SEED_LENGTH, MemcmpFilter, MergeStakeParams, Message, MessageArgs, MessageHeader, NONCE_ACCOUNT_LENGTH, NonceAccount, NonceInformation, PACKET_DATA_SIZE, ParsedAccountData, ParsedConfirmedTransaction, ParsedConfirmedTransactionMeta, ParsedInnerInstruction, ParsedInstruction, ParsedMessage, ParsedMessageAccount, ParsedTransaction, PartiallyDecodedInstruction, PerfSample, ProgramAccountChangeCallback, PublicKey, PublicKeyData, PublicKeyInitData, RootChangeCallback, RpcResponseAndContext, SOLANA_SCHEMA, STAKE_CONFIG_ID, SYSVAR_CLOCK_PUBKEY, SYSVAR_INSTRUCTIONS_PUBKEY, SYSVAR_RECENT_BLOCKHASHES_PUBKEY, SYSVAR_RENT_PUBKEY, SYSVAR_REWARDS_PUBKEY, SYSVAR_STAKE_HISTORY_PUBKEY, Secp256k1Program, SendOptions, SendTransactionError, SerializeConfig, SignaturePubkeyPair, SignatureReceivedNotification, SignatureResult, SignatureResultCallback, SignatureStatus, SignatureStatusConfig, SignatureStatusNotification, SignatureSubscriptionCallback, SignatureSubscriptionOptions, SignaturesForAddressOptions, Signer, SimulatedTransactionAccountInfo, SimulatedTransactionResponse, SlotChangeCallback, SlotInfo, SlotUpdate, SlotUpdateCallback, SplitStakeParams, StakeActivationData, StakeAuthorizationLayout, StakeAuthorizationType, StakeInstruction, StakeInstructionType, StakeProgram, Struct, Supply, SystemInstruction, SystemInstructionType, SystemProgram, TokenAccountBalancePair, TokenAccountsFilter, TokenAmount, TokenBalance, Transaction, TransactionConfirmationStatus, TransactionCtorFields, TransactionError, TransactionInstruction, TransactionInstructionCtorFields, TransactionResponse, TransactionSignature, TransferParams, TransferWithSeedParams, VALIDATOR_INFO_KEY, VOTE_PROGRAM_ID, ValidatorInfo, Version, VoteAccount, VoteAccountInfo, VoteAccountStatus, WithdrawNonceParams, WithdrawStakeParams, clusterApiUrl, sendAndConfirmRawTransaction, sendAndConfirmTransaction };
